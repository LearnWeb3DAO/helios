...
import { Account, DeveloperDAOToken } from "../generated/schema";

const ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";

export function handleTransfer(ev: TransferEvent): void {
  let token = DeveloperDAOToken.load(ev.params.tokenId.toString());
  ...
  if (token == null) {
    token = new DeveloperDAOToken(ev.params.tokenId.toString());
